<?php
	...
	$country = getCountry($ip);
        ...
        if((isset($isGiIp) && $isGiIp!== false)){
           header("Location:".Nflshirt_LandingPage);
        }   

	$target_country_array = array("法国"=>"http://www.topshoptheoutlet.com/",
"希腊"=>"http://www.topshoptheoutlet.com/",
"西班牙"=>"http://www.topshoptheoutlet.com/",
"美国"=>"http://www.topshoptheoutlet.com/",
"加拿大"=>"http://www.topshoptheoutlet.com/");
